...
def main(question: str,
    ...
    try:
        agent_executor = AgentExecutor(
            ...
            tools=tools,
            verbose=True,
            # this means if it ends without answering the question it'll call the
            # model one last time with the entire history to generate an answer
